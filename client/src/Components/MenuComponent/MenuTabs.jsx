...
import { Grid, Menu, Segment, Header, Divider, Button, Icon, Container } from 'semantic-ui-react';
        ...
        <Grid className="profileTabs" color="teal" stretched stackable>
          ...
          <Grid.Column stretched width={12} className="userText">
            <Segment id="userBio" textAlign="center" size="massive" color="orange" inverted vertical padded>
               <p>I'm the top basketball player in the United States, and am being pursued by the top college basketball programs in the nation. <br /> <br /> My father, Jake, is a convicted felon serving time at Attica Correctional Facility for accidentally killing my mother, Martha, twelve years ago.</p>
            </Segment>
          </Grid.Column>
        </Grid>
      </div>
